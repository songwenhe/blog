<template>
  <div class="asider">
    <myCard title="关于我" icon="el-icon-s-home" v-if="isLogin">
      <div class="about">
        <div class="qr-code">
          <img
    ...
    <myCard title="目录" icon="fa-book" class="toc-card" v-if="notEmpty(toc)">
      <ul class="toc">
        <li class="toc-item" v-for="i in toc" :key="i.id">
